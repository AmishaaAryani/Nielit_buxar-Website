                ...
                <div className="topbar">
                    ...
                    <div className="topbar-right">
                        <ul>
                            ...
                            <li className="header-hide aminus"><a href="#" id="decfont"><img alt="font small" src="../../nielit.gov.in/sites/all/themes/berry/images/a-minus.png" width="12" height="12" /></a></li>
                            <li className="header-hide anormal"><a href="#" id="normal"><img alt="font normal" src="../../nielit.gov.in/sites/all/themes/berry/images/a-normal.png" width="11" height="11" /></a></li>
                            <li className="header-hide aplus"><a href="#" id="incfont"><img alt="font increase" src="../../nielit.gov.in/sites/all/themes/berry/images/a-plus.png" /></a></li>
                            <li id="header-hindi">
                            ...
                            <li id="header-search"><div className="region region-content-search">
                                <section id="block-custom-search-blocks-1" className="block block-custom-search-blocks">
                                    ...
                                    <div className="content">
                                        <form className="search-form" role="search" action="https://www.nielit.gov.in/buxar/index.php" method="post" id="custom-search-blocks-form-1" accept-charset="UTF-8" target="_self"><div><div className="form-item form-type-textfield form-item-custom-search-blocks-form-1">
                                            ...
                                            <input type="hidden" name="form_build_id" value="form-vgUXEpww-jUcYhfl8aQNH5jm3zTc3rbHSvOzQjlnABE" />
